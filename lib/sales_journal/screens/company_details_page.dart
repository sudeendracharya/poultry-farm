...
import 'package:poultry_login_signup/sales_journal/screens/company_sales_details_page.dart';
...
class CompanyDetailsPage extends StatefulWidget {
  ...
  static const routeName = '/ComapanyDetailsPage';
...
class _CompanyDetailsPageState extends State<CompanyDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    individualCompanyInfo =
        Provider.of<JournalApi>(context).individualCompanyInfoData;
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: individualCompanyInfo.isEmpty
              ? const SizedBox()
              : Column(
                  children: [
                    Row(
                      children: [
                        TextButton(
                          ...
                          child: Text('Companys List', style: breadCrumpsStyle),
                        ),
                        const Icon(
                        ...
                        TextButton(
                          ...
                          child:
                              Text('Company Details', style: breadCrumpsStyle),
                        ),
                        // const Icon(
                        //   Icons.arrow_back_ios_new,
                        //   size: 15,
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            individualCompanyInfo['Company_Name'],
                            style:
                      ...
                      child: Container(
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                getHeadingContainer('Contact Person Name'),
                                const SizedBox(
                                  width: 49,
                                ),
                                getDataContainer(
                                  individualCompanyInfo['Contact_Person_Name'],
                                ),
                              ],
                            ),
                            const SizedBox(
