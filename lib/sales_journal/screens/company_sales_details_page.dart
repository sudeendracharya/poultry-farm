...
class CompanySalesDetailsPage extends StatefulWidget {
  CompanySalesDetailsPage({Key? key}) : super(key: key);
  static const routeName = '/CompanySalesDetailsPage';
  @override
  State<CompanySalesDetailsPage> createState() =>
      _CompanySalesDetailsPageState();
}

class _CompanySalesDetailsPageState extends State<CompanySalesDetailsPage> {
  var query = '';
    ...
    getProductData().then((value) {
      Provider.of<Apicalls>(context, listen: false)
        ...
        Provider.of<JournalApi>(context, listen: false)
            .getIndividualCompanySalesJournalInfo(saleId, token);
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    salesDetails =
        Provider.of<JournalApi>(context).individualCompanySalesDataList;
                  ...
                  child: Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            getHeadingContainer('Company Name'),
                            const SizedBox(
                              width: 55,
                            ),
                            salesDetails.isEmpty
                                ? const SizedBox()
                                : getDataContainer(
                                    salesDetails['Company_Id__Company_Name']),
                          ],
                        ),
                        const SizedBox(
                          height: 15,
